...
"""runt experimenten en bewaart ze in files, was een eerste versie voor experimenten"""
...
#probeersel voor iets anders dan tijd te meten, niet gelukt
...
#compilatie meten volgens random heuristiek, nrOfIterations keer met een andere volgorde
